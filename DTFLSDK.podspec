#
#  Be sure to run `pod spec lint DTFLSDK.podspec' to ensure this is a
...
DTFLSDK is for doing face-capture. Taking the selfie and sending to backend for liveness check
                   DESC

  spec.homepage     = "https://github.com/DigiTapAi/DTFLSDK"
  ...
  spec.source       = { :git => "https://github.com/DigiTapAi/DTFLSDK.git", :tag => spec.version.to_s }
