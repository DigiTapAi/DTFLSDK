...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DTFL",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC4DTFL17AccessibilityInfo")
@interface AccessibilityInfo : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithIsSystemAccessibilityEnabled:(BOOL)isSystemAccessibilityEnabled isConfigAccessibilityEnabled:(BOOL)isConfigAccessibilityEnabled OBJC_DESIGNATED_INITIALIZER;
- (BOOL)isSystemAccessibilityEnabled SWIFT_WARN_UNUSED_RESULT;
...
- (void)setFaceEyesClosedDescription:(NSString * _Nonnull)desc;
...
- (void)setFaceBlurDescription:(NSString * _Nonnull)desc;
- (void)setFaceMaskDescription:(NSString * _Nonnull)desc;
- (void)setFaceNonAlignedDescription:(NSString * _Nonnull)desc;
- (void)setFaceLowLightDescription:(NSString * _Nonnull)desc;
- (void)setFaceOccludedDescription:(NSString * _Nonnull)desc;
- (void)setCancelDialogTitle:(NSString * _Nonnull)title;
- (void)setCancelDialogDesc:(NSString * _Nonnull)desc;
- (void)setCancelDialogYesBtnText:(NSString * _Nonnull)text;
- (void)setCancelDialogNoBtnText:(NSString * _Nonnull)text;
- (void)setTryAgainBtnText:(NSString * _Nonnull)desc;
- (void)setAllowMultipleFace:(NSString * _Nonnull)allow;
- (void)setAllowEyesClosed:(NSString * _Nonnull)allow;
- (void)setAllowBlurFace:(NSString * _Nonnull)allow;
- (void)setAllowFaceMask:(NSString * _Nonnull)allow;
